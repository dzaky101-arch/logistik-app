# Script Launcher untuk SheetLog Pickup Scanner
...
Write-Host "      SHEETLOG PICKUP SCANNER LOCAL SERVER   " -ForegroundColor Yellow
Write-Host "=============================================" -ForegroundColor Yellow
Write-Host "Membuka terminal scanner di browser..." -ForegroundColor Cyan
