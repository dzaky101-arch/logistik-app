# Script Launcher untuk SheetBot Pickup
...
Write-Host "          SHEETBOT PICKUP LOCAL SERVER       " -ForegroundColor Yellow
Write-Host "=============================================" -ForegroundColor Yellow
Write-Host "Membuka dashboard pickup di browser..." -ForegroundColor Cyan
